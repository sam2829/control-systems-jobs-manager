...
| logged out user cannot create a job. | When a user is logged out and on the jobs URL, the post form is not on display and the user unable to create a job. |Made sure I was logged out and went to the jobs URL. | The job form was not on display and I was unable to create a job. | Pass |
